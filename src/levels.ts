...
export const LEVELS: LevelCfg[] = [
  ...
  },
  {
    ...
    waves: [
      { prewave: 18, drops: [{ type: 'swarm', n: 12 }] },
      { prewave: 24, drops: [{ type: 'swarm', n: 14 }, { type: 'runner', n: 8 }] },
      { prewave: 24, drops: [{ type: 'armored', n: 5 }, { type: 'swarm', n: 12 }], divers: 1 },
      { prewave: 26, drops: [{ type: 'armored', n: 7 }, { type: 'runner', n: 10 }, { type: 'swarm', n: 14 }], divers: 2 },
    ],
  },
  {
    ...
    waves: [
      ...
      { prewave: 24, drops: [{ type: 'runner', n: 12 }], jammers: 1 },
      { prewave: 24, drops: [{ type: 'armored', n: 7 }, { type: 'swarm', n: 14 }] },
      { prewave: 24, drops: [{ type: 'swarm', n: 16 }, { type: 'runner', n: 10 }], jammers: 1 },
      { prewave: 26, drops: [{ type: 'armored', n: 9 }, { type: 'swarm', n: 14 }, { type: 'runner', n: 8 }] },
    ],
  },
  {
    ...
    waves: [
      ...
      { prewave: 26, drops: [{ type: 'armored', n: 9 }, { type: 'runner', n: 10 }], gunships: 1 },
      { prewave: 28, drops: [{ type: 'armored', n: 9 }, { type: 'armored', n: 7 }, { type: 'swarm', n: 16 }], divers: 2 },
      { prewave: 28, drops: [{ type: 'armored', n: 11 }, { type: 'runner', n: 12 }, { type: 'swarm', n: 18 }], gunships: 1, divers: 2 },
    ],
  },
  {
    ...
    waves: [
      ...
      { prewave: 24, drops: [{ type: 'splitter', n: 7 }, { type: 'runner', n: 12 }, { type: 'swarm', n: 12 }, { type: 'swarm', n: 10 }], divers: 2 },
      { prewave: 26, drops: [{ type: 'splitter', n: 11 }, { type: 'armored', n: 9 }, { type: 'swarm', n: 14 }, { type: 'runner', n: 10 }], divers: 2 },
    ],
  },
  {
    ...
    waves: [
      { prewave: 18, drops: [{ type: 'swarm', n: 14 }], jammers: 1, divers: 1 },
      { prewave: 24, drops: [{ type: 'runner', n: 12 }], jammers: 1, divers: 2 },
      { prewave: 24, drops: [{ type: 'swarm', n: 18 }], jammers: 2, gunships: 1 },
      { prewave: 26, drops: [{ type: 'armored', n: 11 }], divers: 3, gunships: 1 },
      { prewave: 26, drops: [{ type: 'swarm', n: 18 }, { type: 'runner', n: 12 }], jammers: 2, divers: 2, gunships: 1 },
      { prewave: 28, drops: [{ type: 'armored', n: 13 }, { type: 'swarm', n: 18 }], divers: 3, gunships: 2 },
    ],
  },
  {
    ...
    waves: [
      ...
      { prewave: 24, drops: [{ type: 'armored', n: 9 }, { type: 'splitter', n: 7 }], jammers: 1, divers: 1 },
      { prewave: 24, drops: [{ type: 'runner', n: 14 }, { type: 'swarm', n: 16 }], divers: 2, gunships: 1 },
      { prewave: 26, drops: [{ type: 'armored', n: 11 }, { type: 'splitter', n: 9 }], jammers: 2 },
      { prewave: 26, drops: [{ type: 'runner', n: 14 }, { type: 'swarm', n: 18 }], divers: 3, gunships: 1 },
      { prewave: 28, drops: [{ type: 'armored', n: 13 }, { type: 'splitter', n: 9 }, { type: 'swarm', n: 18 }], jammers: 1, gunships: 1 },
      { prewave: 30, drops: [{ type: 'armored', n: 11 }, { type: 'swarm', n: 18 }], divers: 3, boss: true },
    ],
  },
];
